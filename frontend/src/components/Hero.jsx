...
const Hero = () => {
  return (
    <>
        <div className='h-[564px] bg-no-repeat bg-cover bg-center  bg-[url(https://images.unsplash.com/photo-1494500764479-0c8f2919a3d8?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)]'>
  ...
  <div className="flex">
    ...
    <div className="relative w-full">
      <input
        ...
        placeholder="Search Rented Rooms..."
        required=""
      />
      <button
        type="submit"
