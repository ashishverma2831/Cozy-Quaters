    ...
    <>
      ...
      <section className=' mx-auto max-w-screen-lg my-10'>
        <div className='flex p-2 justify-between items-center'>
          <div className='px-4'>
            <p className='text-xl font-semibold'>{room[0].title.toUpperCase()}
              <span className="mx-2 text-white bg-[#065c77] text-md font-medium px-4 py-1.5 rounded"> {room[0].accomodationFor} </span>
            </p>
